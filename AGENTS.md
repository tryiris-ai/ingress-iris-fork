...
~/iris/ai.knowledge/rules/ingress-iris-fork/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/ingress-iris-fork/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|ingress-iris-fork {rule}`
Explained something new → `/iris-learn global|ingress-iris-fork {context}`
